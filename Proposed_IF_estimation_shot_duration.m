function [fidexmult] = Proposed_IF_estimation_shot_duration(Sig, num, delta)
...
%Spec=tfr_stft_high(Sig);
  [Spec1,orienttfd1]=HTFD_neww(Sig,2,8,64);
[Spec2,orienttfd2]=HTFD_neww(Sig,2,50,104);% 
